...
deb http://us.archive.ubuntu.com/ubuntu $flavor main restricted universe multiverse
deb http://us.archive.ubuntu.com//ubuntu $flavor-updates main restricted universe multiverse
deb http://us.archive.ubuntu.com//ubuntu $flavor-proposed main restricted universe multiverse
# deb http://us.archive.ubuntu.com//ubuntu $flavor-backports main restricted universe multiverse
# deb http://security.ubuntu.com/ubuntu $flavor-security main restricted universe multiverse

deb-src http://us.archive.ubuntu.com/ubuntu $flavor main restricted universe multiverse
deb-src http://us.archive.ubuntu.com//ubuntu $flavor-updates main restricted universe multiverse
deb-src http://us.archive.ubuntu.com//ubuntu $flavor-proposed main restricted universe multiverse
# deb-src http://us.archive.ubuntu.com//ubuntu $flavor-backports main restricted universe multiverse
