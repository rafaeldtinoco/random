...
FLAVOR=$5	    # default: "eoan"

ALLFLAVORS="xenial bionic cosmic disco eoan"

PACKAGES="""\
locales,less,vim,sudo,openssh-server,bash-completion,\
wget,rsync,git,bridge-utils,vlan,net-tools,ncurses-term,\
...
tcpdump,curl,openssh-server,openssh-client,git,\
...
iface eth0 inet manual
    ...
    post-down sysctl -w net.ipv4.conf.eth0.forwarding=0
    post-down sysctl -w net.ipv6.conf.eth0.disable_ipv6=0
